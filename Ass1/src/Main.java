...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        GeneralPractitioner gp2 = new GeneralPractitioner(102, "Dr. Umme Habiba", "Chronic Diseases", 20);
        gp2.printInfo();
        System.out.println("--------------------");

        GeneralPractitioner gp3 = new GeneralPractitioner(103, "Dr. Adolphus Dsilva", "Paediatrics", 15);
        gp3.printInfo();
        System.out.println("--------------------");


        // Create a Specialist using the parameterized constructor
        Specialist sp1 = new Specialist(201, "Dr. Timothy Andrew", "Mental Health", "mental diseases");
        sp1.printInfo();
        System.out.println("--------------------");

        Specialist sp2 = new Specialist(202, "Dr. Beatriz", "Women's Health", "Gynaecology");
        sp2.printInfo();
        System.out.println("--------------------");
